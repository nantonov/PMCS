...
type MealProps = IMeal & {deleteMeal: typeof deleteMeal};

const MealActivity: React.FC<MealProps> = ({ dateTime, title, description, pet, deleteMeal, id }) => {
    const handleDeleteButtonClick = () => deleteMeal(id);
