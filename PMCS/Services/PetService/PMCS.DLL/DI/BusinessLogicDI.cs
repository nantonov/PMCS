...
namespace PMCS.DLL.DI
{
    ...
    {
        public static void RegisterBusinessLogicDependencies(this IServiceCollection services, IConfiguration config)
        {
            ...
            services.RegisterDataAccessDependencies(config);
        }
    }
}
